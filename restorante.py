...
def restorante(number_dialog):
    pygame.mixer.pre_init(44100, -16, 1, 512)
    # Инициализация Pygame
    pygame.init()
    active_dialog = number_dialog
    ...
    # Загрузка фонового изображения - приветствие
    ...
    def draw_dialog_ofic(string,str2):
        x = 250
        y = 50
        width = 730
        height = 100
    ...
    def draw_dialog_character(string, str2, x, y, color_button, color_words):
    ...
    def handle_click(mouse_x,  mouse_y, respuestaCorrecto):
